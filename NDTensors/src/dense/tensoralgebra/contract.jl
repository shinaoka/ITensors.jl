...
# Check consecutive labels in ai and fuse them if possible
...
# Fuse labels recursively
function _recursive_fuse_labels(
  ai::Vector{Int},
  bi::Vector{Int},
  ci::Vector{Int},
  sizea::Vector{Int},
...
function contract!(
  ...
  labelsT1_, labelsT2_, labelsR_, sizeT1_, sizeT2_, sizeR_ = _recursive_fuse_labels(
